...
/**
 * create_buffer - this allocates some bytes for a buffer.
...
/**
 * close_file - this also closes the file descriptors.
...
/**
 * main - this shows the copies the contents of a file to another file.
 * @argc: this is the number of arguments supplied to the program.
 * @argv: this is group of an array of pointers to the arguments.
 *
